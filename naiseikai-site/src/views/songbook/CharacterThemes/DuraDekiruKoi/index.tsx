...
export default function CharacterThemes_DuraDekiruKoi() {
  return (
    <div className="page-container">
      ...
      <div className="mb-10">
        ...
        <p className="text-text-muted text-base leading-relaxed max-w-2xl">
          Character themes and compositions for Dura Dekiru Koi.
        </p>
      </div>
      ...
      <div className="callout">
        ...
        <p className="text-sm text-text-muted leading-relaxed">
          Character themes for Dura Dekiru Koi are being composed. Check back soon.
        </p>
      </div>
