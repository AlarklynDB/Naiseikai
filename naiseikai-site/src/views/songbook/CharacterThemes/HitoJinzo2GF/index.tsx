...
function Breadcrumb() {
  return (
    <nav className="flex items-center gap-2 text-xs font-mono text-text-faint mb-8 flex-wrap">
      ...
      <span>/</span>
      <span className="text-[#00e5ff]">Hito Jinzo 2GF</span>
    </nav>
  )
}

export default function CharacterThemes_HitoJinzo2GF() {
  return (
    <div className="page-container">
      ...
      <div className="mb-10">
        ...
        <h1 className="font-serif text-4xl sm:text-5xl mb-4 text-text">Hito Jinzo 2GF</h1>
        <p className="text-text-muted text-base leading-relaxed max-w-2xl">
          Character themes and compositions for Hito Jinzo 2GF.
        </p>
      </div>
      ...
      <div className="callout">
        ...
        <p className="text-sm text-text-muted leading-relaxed">
          Character themes for Hito Jinzo 2GF are being composed. Check back soon.
        </p>
      </div>
