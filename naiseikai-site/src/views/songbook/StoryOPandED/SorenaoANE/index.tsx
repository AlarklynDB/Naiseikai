...
export default function StoryOPandED_SorenaoANE() {
  return (
    <div className="page-container">
      ...
      <div className="mb-10">
        ...
        <p className="text-text-muted text-base leading-relaxed max-w-2xl">
          Opening and ending themes for Sorenao ANE.
        </p>
      </div>
      ...
      <div className="callout">
        ...
        <p className="text-sm text-text-muted leading-relaxed">
          Story OP/EDs for Sorenao ANE are being produced. Check back soon.
        </p>
      </div>
