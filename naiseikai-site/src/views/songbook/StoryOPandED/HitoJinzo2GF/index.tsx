...
export default function StoryOPandED_HitoJinzo2GF() {
  return (
    <div className="page-container">
      ...
      <div className="mb-10">
        ...
        <p className="text-text-muted text-base leading-relaxed max-w-2xl">
          Opening and ending themes for Hito Jinzo 2GF.
        </p>
      </div>
      ...
      <div className="callout">
        ...
        <p className="text-sm text-text-muted leading-relaxed">
          Story OP/EDs for Hito Jinzo 2GF are being produced. Check back soon.
        </p>
      </div>
