...
export default function StoryOPandED_TQCTN() {
  return (
    <div className="page-container">
      ...
      <div className="mb-10">
        ...
        <p className="text-text-muted text-base leading-relaxed max-w-2xl">
          Opening and ending themes for Karasu to Ninja (TQCTN).
        </p>
      </div>
      ...
      <div className="callout">
        ...
        <p className="text-sm text-text-muted leading-relaxed">
          Story OP/EDs for Karasu to Ninja (TQCTN) are being produced. Check back soon.
        </p>
      </div>
